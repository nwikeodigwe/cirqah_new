...
const Shipping = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-5 mt-16">
      <h3 className="text-lg font-medium col-span-2">Shipping Address</h3>
      <Fieldset.Root className="col-span-2">
        ...
        <Fieldset.Input
          ...
          placeholder=""
        />
        <Fieldset.Error>{errors.shipping_address?.message}</Fieldset.Error>
      </Fieldset.Root>
      <Fieldset.Root className="col-span-2">
        ...
        <Fieldset.Input
          ...
          placeholder=""
        />
        <Fieldset.Error>{errors.shipping_address_2?.message}</Fieldset.Error>
      </Fieldset.Root>
      <Fieldset.Root className="col-span-2">
        ...
        <Fieldset.Input
          ...
          placeholder=""
        />
        <Fieldset.Error>{errors.shipping_city?.message}</Fieldset.Error>
      </Fieldset.Root>
      <Fieldset.Root className="col-span-2">
        ...
        <Fieldset.Error>{errors.shipping_country?.message}</Fieldset.Error>
      </Fieldset.Root>
      <Fieldset.Root>
        ...
        <Fieldset.Input
          ...
          placeholder=""
        />
        <Fieldset.Error>{errors.shipping_postal_code?.message}</Fieldset.Error>
      </Fieldset.Root>
      <Fieldset.Root>
        ...
        <Fieldset.Input
          ...
          placeholder=""
        />
        <Fieldset.Error>{errors.shipping_state?.message}</Fieldset.Error>
      </Fieldset.Root>
    </div>
  );
};
