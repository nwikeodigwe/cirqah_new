...
const options = () => {
  return (
    <div className="grid grid-cols-4 gap-2">
        <Link to="#" className="flex flex-col justify-center h-30 my-10 shadow-sm p-2 bg-gradient-to-tr from-black/70 to-red-500/20 text-white space-y-2">
            <span><SiEventstore className="text-4xl" /></span>
            <h2 className="font-bold">Create Event</h2>
        </Link>
        <Link to="#" className="flex flex-col justify-center h-30 my-10 shadow-sm p-2 bg-gradient-to-tr from-black/70 to-green-500/20 space-y-2">
